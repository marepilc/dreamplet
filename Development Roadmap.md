...
*Goal: Initialize the Skia WebAssembly environment and render basic graphics within a modern Vite workflow.*
...
*Goal: Drive the Skia render loop using GSAP’s high-performance timing engine.*
...
*Goal: Integrate vector animations with the flexibility of code-based control.*
...
*Goal: Provide high-level tools that make complex visual effects easy to write.*
...
*Goal: Finalize for public use and performance at scale.*
